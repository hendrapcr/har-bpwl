<?php 
	...
	if(isset($_POST['daftar'])){
		...
		if($pass != $confirmPass){
			...
			$sql = $conn -> query("INSERT INTO user(nama, email, username, password, noHp) VALUES ('$nama','$email'
				,'$username','$pass','$noHp')");

			if($sql){
				$_SESSION['nama'] = $nama;
				echo '<script>
					alert("Welcome to Keranjaa, '.$nama.' !");
					window.location = "../";
				</script>';		
			}
			else{
				...
				<div class="row">
					<div class="col-md-10 col-md-offset-1">
						<div class="header-signUp" style="text-align: center">
							<h1>Sign Up</h1>
							<hr style="border:1px solid #7dbb26">
						</div>
						<form action="" method="POST">
							<div class="body-signUp">
								<div class="row">
									<div class="col-md-6" style="border-right: .3px solid #7dbb26">
